...
d3.csv("ndx.csv", function (data) {
    ...
    yearlyBubbleChart
        ...
        .colors(colorbrewer.Oranges[3]) // (optional) define color function or array for bubbles
    ...
    quarterChart.width(180)
        ...
        .innerRadius(30)
        .dimension(quarter)
        .ordinalColors(['#395286', '#005E92', '#DF823D', '#51ABD0', '#51ABD0'])
        .group(quarterGroup);

    //#### Row Chart
    dayOfWeekChart.width(180)
        .height(null)
        .margins({top: 20, left: 10, right: 10, bottom: 50})
        .group(dayOfWeekGroup)
        .dimension(dayOfWeek)
        // assign colors to each value in the x scale domain
        .ordinalColors(['#395286', '#005E92', '#DF823D', '#F4712A', '#51ABD0'])
        .label(function (d) {
